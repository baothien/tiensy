...
for id_obj in np.arange(len(sub)):
	input_anatomy_ref = "/home/bao/tiensy/Lauren_registration/data_compare_mapping/anatomy/" + str(sub[id_obj])+ "_anatomybet.nii.gz"
...
sub = [202,204]#[205,206,209,212]#
input_path =  '/home/bao/tiensy/Lauren_registration/data_compare_mapping/out_registered/iteration_4/'
output_path = '/home/bao/tiensy/Lauren_registration/data_compare_mapping/out_registered/iteration_4/'
