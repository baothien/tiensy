...
class Window(QtGui.QWidget):
    ...
    def screenshot(self, out_filename='temp.png'):
    ...
    def recording(self, n_frames=50, start_frame = 0, rotation = False, out_path='/home/bao/tiensy/temp/'):
        ...
        if rotation == True:
            ...
            for i in range(n_frames):               
                ...
                self.glWidget.updateGL()
                if out_path==None:
                    filename=str(1000000+start_frame + i)+'.png'
                else:
    ...
    def keyPressEvent(self, event):
        ...
        if key == QtCore.Qt.Key_F1:
            ...
            #file_name = dlg.getText(self.tr("QInputDialog().getText()"),
            #                         self.tr("File  name:"), echo = QtGui.QLineEdit.Normal)#,text = 'file_name.png')
            #file_name = dlg.getText(parent=QtGui.QWidget, title = 'File name', label = 'Enter file name to save')
            #if (file_name):   
            #    print file_name
            #    self.screenshot( file_name)#'temp.png')
            self.screenshot( 'temp.png')
        elif key == QtCore.Qt.Key_F6: #for recording the screen
            self.recording(10)
