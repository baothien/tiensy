...
\author{\IEEEauthorblockN{Emanuele Olivetti\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}
    , \emph{Member}, \emph{IEEE}, Thien Bao
    Nguyen\IEEEauthorrefmark{1}\IEEEauthorrefmark{2} and Eleftherios Garyfallidis\IEEEauthorrefmark{3}
%    email: \url{olivetti@fbk.eu}
}
...
\IEEEauthorblockA{\IEEEauthorrefmark{3}MRC Cognition and Brain
  Sciences Unit, University of Cambridge, UK}
}
...
\begin{IEEEkeywords}
  dMRI; tractography; Euclidean embedding; dissimilarity
  representation; prototype selection;
\end{IEEEkeywords}
...
\bibliography{ntbaovn-similarity.bib}
