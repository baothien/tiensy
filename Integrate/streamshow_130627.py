...
# Interaction Logic:
from manipulator_130627 import Manipulator
...
class StreamlineLabeler(Actor, Manipulator):   
    ...
    """
    def __init__(self, name, buffers, clusters, representative_buffers=None, 
                 colors=None, vol_shape=None, 
                 representatives_line_width=5.0, streamlines_line_width=2.0,
                 representatives_alpha=1.0, streamlines_alpha=0.6,
                 affine=None, verbose=False, 
                 clustering_parameter=None, clustering_parameter_max=None, full_dissimilarity_matrix=None):
