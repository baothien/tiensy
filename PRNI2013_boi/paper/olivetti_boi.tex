...
\author{\IEEEauthorblockN{Emanuele
    ...
    Nivedita Agarwal\IEEEauthorrefmark{4}\IEEEauthorrefmark{2} and
    Paolo Avesani\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}
  }
  ...
  \IEEEauthorblockA{\IEEEauthorrefmark{4} University of Sherbrooke,
    QC, Canada}
  \IEEEauthorblockA{\IEEEauthorrefmark{4}Azienda Provinciale per i
    Serivi Sanitari, Trento, Italy}
}
