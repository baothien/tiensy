# -*- coding: utf-8 -*-
"""
Created on Thu May 16 17:59:13 2013
...
from functionInterfaces import BrainExtraction, EddyCorrection, ResampleVoxelSize, TensorModel, Tracking
 
data = '/home/bao/tiensy/Nipype_tutorial/data/dmri/temp3/raw.nii.gz'
path = '/home/bao/tiensy/Nipype_tutorial/data/dmri/temp3/'
...
tensor_model_node.inputs.input_filename_data = path + 'data_bet_ecc_iso.nii.gz'
...
tracking_node.inputs.low_thresh = .2
