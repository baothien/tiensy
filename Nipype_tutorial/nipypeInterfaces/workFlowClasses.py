...
from classInterfaces import SelectTrialLabel, Create3DMatrix, Encoding, Classification

                                         
###### WORKFLOW DEFINITION #######
aWf=pe.Workflow(name="aWf")
aWf.base_dir="/home/vittorio/Projects/nipypeInterfaces/theClasses/results"

###### NODE DEFINITION #######
select_trial_label_node = pe.Node(interface=SelectTrialLabel(), name="select_trial_label_node")
create_3Dmatrix_node = pe.Node(interface=Create3DMatrix(), name="create_3Dmatrix_node")
encoding_node = pe.Node(interface=Encoding(), name='encoding_node')
classification_node = pe.Node(interface=Classification(), name='classification_node')

###### INPUT NODE DEFINITION #######
#inputs: select_trial_label_node
select_trial_label_node.inputs.input_filename='/home/vittorio/Projects/nipypeInterfaces/theClasses/data/121120Adriano01.fif'
