...
def compute_disimilarity(data, distance, prototype_policy, num_prototypes, prototype = None, verbose=False, size_limit=500000):
    if prototype == None:
    ...
    print
    return data_disimilarity, prototype
