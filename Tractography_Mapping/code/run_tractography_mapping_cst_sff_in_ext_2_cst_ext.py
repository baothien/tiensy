...
for s_id in np.arange(len(source_ids)):
    for t_id in np.arange(len(target_ids)):
        if target_ids[t_id] != source_ids[s_id]:
            ...
            arg6 = '-pr=50'
            arg7 = '-an=200'
            arg8 = '/home/bao/tiensy/Tractography_Mapping/data/trackvis_tractography/results/result_cst_sff_in_ext_2_cst_ext/50_SFF_native/map_best_' + source + '_' + target + '_cst_L_ann_200.txt'
            arg9 = '/home/bao/tiensy/Tractography_Mapping/data/trackvis_tractography/results/result_cst_sff_in_ext_2_cst_ext/50_SFF_native/map_1nn_' + source + '_' + target + '_cst_L_ann_200.txt'
            arg10 = '/home/bao/tiensy/Tractography_Mapping/data/trackvis_tractography/results/result_cst_sff_in_ext_2_cst_ext/50_SFF_native/map_best_' + source + '_' + target + '_cst_L_ann_100.txt'
            import sys
            sys.argv = [fname, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10]
            execfile(fname)
            clearall()            
            '''
            ...
            arg6 = '-pr=50'
            arg7 = '-an=400'
            arg8 = '/home/bao/tiensy/Tractography_Mapping/data/trackvis_tractography/results/result_cst_sff_in_ext_2_cst_ext/50_SFF_native/map_best_' + source + '_' + target + '_cst_R_ann_400.txt'
            arg9 = '/home/bao/tiensy/Tractography_Mapping/data/trackvis_tractography/results/result_cst_sff_in_ext_2_cst_ext/50_SFF_native/map_1nn_' + source + '_' + target + '_cst_R_ann_400.txt'
            arg10 = '/home/bao/tiensy/Tractography_Mapping/data/trackvis_tractography/results/result_cst_sff_in_ext_2_cst_ext/50_SFF_native/map_best_' + source + '_' + target + '_cst_R_ann_200.txt'            
            import sys
            sys.argv = [fname, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10]
            execfile(fname)
            clearall() 
