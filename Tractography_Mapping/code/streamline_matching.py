...
if __name__ == '__main__':
    ...
    for i in np.arange(len(lines)):
        fvtk.add(r, fvtk.line(lines[i], fvtk.red, opacity=1.0))
    
    lines = [tracks[sid]]
    #c = fvtk.streamtube(lines, fvtk.colors.cyan)    
    #c = fvtk.line(lines, fvtk.cyan)    
    #fvtk.add(r,c)
    for i in np.arange(len(lines)):
        fvtk.add(r, fvtk.line(lines[i], fvtk.cyan, opacity=1.0))
    ...
    #c = fvtk.line(lines, fvtk.blue)    
    #fvtk.add(r,c)
    for i in np.arange(len(lines)):
        fvtk.add(r, fvtk.line(lines[i], fvtk.blue, opacity=1.0))
    
    lines = [tracks[best]]
    #c = fvtk.line(lines, fvtk.green)    
    #fvtk.add(r,c)
    for i in np.arange(len(lines)):
        fvtk.add(r, fvtk.line(lines[i], fvtk.green, opacity=1.0))
