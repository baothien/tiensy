...
from common_functions import load_tract, Shannon_entropy, visualize_tract, length_min, length_max, length_avg
...
visualize = False
print '---------------------------------------------------------------------------'
print 'Subject \t CST_Len_min  \t CST_Len_min  \t CST_Len_min \t CST_Entropy \t CST_ext_Len_min  \t CST_ext_Len_max  \t CST_ext_Len_avg \t CST_ext_Entropy'
for s_id in np.arange(len(sub_ids)):
    ...
    print sub,"\t", len(cst), "\t", cst_len_min,"\t", cst_len_max,"\t", cst_len_avg , "\t" , cst_entropy ,"\t", len(cst_ext), "\t", cst_ext_len_min,"\t", cst_ext_len_max,"\t", cst_ext_len_avg , "\t" , cst_ext_entropy         
