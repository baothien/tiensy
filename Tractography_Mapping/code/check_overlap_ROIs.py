...
def nativevoxel2MNImm_all(ROIs_sub):
    ...
    for i in np.arange(len(ids)):
        ...
        #convert from LPS to LAS
        ROIs = [[r[0],128.-r[1],r[2]] for r in ROIs]     
        
        #nativevoxel2MNImm(ROIs[0], fa, flirt_mat)
        nativevoxel2MNImm(ROIs[1], fa, flirt_mat)        
...
#nativevoxel2MNImm_all(ROIs_native_voxel_L)
#MNImm2MNIvoxel_all(ROIs_MNI_mm_L_LAS)
#stop
#mklink()

#ROIs_subject = ROIs_MNI_voxel_R
#ROIs_subject = ROIs_native_voxel_R
ROIs_subject = ROIs_native_voxel_L
